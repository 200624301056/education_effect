...
<input type="hidden" name="showPage" value="<%=strPage%>">
	...
	<tr>
		...
		<td width="37%"height="41" align="left">&nbsp;&nbsp;<input name="Birth" type="text" class="input1" id="Birth" value="<%=User.getBirth()%>">例如：1988-09-20</td>
	</tr>
	<tr>
		...
		<td width="37%"height="48" align="left">&nbsp;&nbsp;<input name="Email" type="text" class="input1" value="<%=User.getEmail()%>">例如：xx@qq.com</td>
	</tr>
	<tr>
		...
		<td width="37%"height="39" align="left"></td>
	</tr>
	<tr>
