...
<%
		...
		else
		{
			...
			{
				out.println("<p><font color=blue>添加学生综合素质成绩信息成功</font></p>");
				out.println("<a href='./add_integrate_score.jsp' target='_self'><font color=blue>继续添加</font></a>");
			}
			else
			{
				out.println("<p><font color=#0000FF>添加学生综合素质成绩息失败，请稍后重试</font></p>");
