...
<html>
	...
	<tr>
		...
		<td width="37%"height="41" align="left">&nbsp;&nbsp;<input name="Birth" type="text" class="input1" id="Birth" size="20">例如：1988-09-20</td>
	</tr>
	<tr>
		<td width="13%"height="48" align="right">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
		<td width="30%"height="48" align="left">&nbsp;&nbsp;<input type="radio" value="男" name="Sex">男&nbsp;<input type="radio" value="女" name="Sex">女&nbsp;<input type="radio" value="保密" name="Sex">保密</td>
		<td width="20%"height="48" align="right">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</td>
		<td width="37%"height="48" align="left">&nbsp;&nbsp;<input name="Email" type="text" class="input1" size="20">例如：xx@qq.com</td>
	</tr>
	<tr>
