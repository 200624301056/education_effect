...
<jsp:useBean scope="page" id="General" class="com.bar.db.General" />
	...
	if (sStuID != null)
	{
		...
		//删除选中的员工信息
		if(General.delete(sDeleteUserID))
		{
			out.println("<p><font color=blue>通用技术课程成绩信息删除成功</font></p>");
			out.println("<p><a href=\"admin_general_score.jsp?showPage="+strPage+"\" target=\"_self\"><font color=blue>返回通用技术课程成绩信息管理</font></a></p>");
		}
		else
		{	
