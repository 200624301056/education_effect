...
<html>
    ...
    <tr>
		<td height="25" colspan="4" align="center"><h1 style="color:#0F3; font-size:14px">添加新学生信息</h1>
	...
	<tr>
		...
		<td width="30%"height="48" align="left">&nbsp;&nbsp;<input type="radio" value="男" name="sex">男&nbsp;<input type="radio" value="女" name="sex">女&nbsp;</td>
			<td width="20%"height="41" align="right">培训&nbsp;日期：</td>
		<td width="37%"height="41" align="left">&nbsp;&nbsp;<input name="train_date" type="text" class="input1" id="Birth" size="20">例如：1988-09-20</td></tr>
	<tr>
	...
	<tr>
	  ...
	  <td width="13%"height="39" align="right">是否&nbsp;回族：</td>
		<td width="30%"height="39" align="left">&nbsp;&nbsp;<input type="radio" value="0" name="hui_flag">是&nbsp;<input type="radio" value="1" name="hui_flag">否</td>
	  </tr>
	<tr>
