...
<html>
	...
	ResultSet rs = General.show_general(school,grade,class_name,term,stu_name,stu_num);
	//初始化分页显示类
...
%>
	<body bgcolor="#F2F2F2">
		<div align="center">
		<form action="admin_general_score.jsp" method="post" name="tiaojian"> 
		  按条件查找： 
		    &nbsp;&nbsp;
		  <select name="school">
		...
		<form name="form1" method="post" action="delete_gersco.jsp" target="_self">
		<em><input type="hidden" name="showPage" value="<%=showPage%>"></em>
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" >
			<tr>
				  <td height="25" colspan="11" align="center"><em><font size="3"><strong>通用技术成绩管理</strong></font></em>			
				  </td>
		  </tr>
			<tr bgcolor="#CC99FF">
			...
			<th width="15%" align="center"><em>通用技术理论分数</em></th>
			<th width="15%" align="center"><em>通用技术实践分数</em></th>
			<th width="15%" height="30" ><em>学校</em></th>
			<th width="10%" height="30" align="center"><em>年级</em></th>
			<th width="10%" align="center"><em>班级</em></th>
		...
		%>
				...
				<td width="5%" height="25" align="center">&nbsp; 
				  <input type="checkbox" name="DeleteID" value="<%=sData[0]%>"/></td>
				<td width="10%" height="25" align="center"><%=sData[1]%><br></td>
			    <td width="10%" height="25" align="center"><font color="#0000ff"><%=sData[2]%></font><br></td>
			    <td width="15%" height="25" align="center"><%=sData[3]%><br></td>
			    <td width="15%" height="25" align="center"><%=sData[4]%><br></td>
				<td width="15%" height="25" align="center"><%=sData[5]%><br></td>
			    <td width="10%" align="center"><%=sData[6]%><br></td>
				<td width="10%" height="25" align="center"><%=sData[7]%><br></td>
				<td width="5%" height="25" align="center"><%=sData[8]%><br></td>
                <td width="5%" height="25" align="center">&nbsp;<a href="updata_general_score.jsp?Stuid=<%=sData[0]%>&amp;showPage=<%=showPage%>" target="_self"><font color="#0000ff">修改</font></a></td>
				</tr>
		...
		&nbsp;&nbsp; 
		<input type="button" name="btn" class="input1" onclick="javascript:window.location='add_general_score.jsp'" value="添加新学生成绩"> 
		&nbsp;&nbsp; 
		<input type="button" class="input1" value="批量导入成绩" onclick="window.open('import_general.htm')"></em>
		</p>
		</form>
		<p>
		<form action="admin_general_score.jsp" method="post" target="_self">	
			第<font color="#FF0000"><%=showPage%></font>页/共<font color=red><%=pages.getPageCount()%></font>页&nbsp;
			<a href="admin_general_score.jsp?showPage=1" target="_self"><font color="#0000FF">[首页]</font></a>&nbsp;			
			<%
				//判断"上一页"链接是否要显示
				if(showPage > 1)
				{				
  ...
  <%
				...
				{				
			%>
					<a href="admin_general_score.jsp?showPage=<%=showPage+1%>" target="_self"><font color="#0000FF">[下一页]</font> </a>&nbsp;
		  <%
				}
				else
				{
			...
			%> 
			<a href="admin_general_score.jsp?showPage=<%=pages.getPageCount()%>" target="_self"><font color="#0000FF">[尾页]</font> </a>&nbsp;
			转到
