...
<html>
    ...
    <%
		...
		long idinspector_gen = Long.parseLong(sStuid);
		General.setIdinspector_gen(idinspector_gen);
	...
	<div align="center">
	<form name="form1" method="post" action="updata_gerscore_save.jsp" target="_self">
    	<input type="hidden" name="stuid" value="<%=idinspector_gen%>">
		<input type="hidden" name="showPage" value="<%=strPage%>">
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
		<td height="25" colspan="4" align="center"><h1 style="color:#0F3; font-size:14px">修改通用技术学生成绩信息</h1>
	...
	<tr>
		...
		<td width="30%" height="41" align="left">&nbsp;
		  <input name="stu_name" type="text" class="input1" id="Score_fis5" value="<%=General.getSUname()%>"></td>
		<td width="20%" height="41" align="right">学员&nbsp;编号：</td>
		<td width="37%" height="41" align="left">&nbsp;
	    <input name="stu_num" type="text" class="input1" id="General_fis4" value="<%=General.getStu_num()%>"></td>
	  </tr>
	<tr>
		<td width="13%" height="48" align="right">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期：</td>
		<td width="30%" height="48" align="left">&nbsp;
		  <input name="term" type="text" class="input1" id="Score_fis6" value="<%=General.getTerm()%>"></td>
		<td width="20%" height="41" align="right">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;校：</td>
		<td width="37%" height="41" align="left">&nbsp;
	    <input name="school" type="text" class="input1" id="Score_fis3" value="<%=General.getSchool()%>"></td>
	</tr>
	<tr>
		<td width="13%" height="39" align="right">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级：</td>
	<td width="30%" height="39" align="left">&nbsp;
	  <input name="grade" type="text" class="input1" id="Score_fis" value="<%=General.getGrade()%>"></td>
		<td width="20%" height="48" align="right">班&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;级：</td>
		<td width="37%" height="48" align="left">&nbsp;
		<input name="class_name" type="text" class="input1" id="Score_fis2" value="<%=General.getClass_name()%>"></td>
	</tr>
	  	<tr>
	  <td height="48" align="right">通用技术课程理论分数：</td>
	  <td height="48" align="left">&nbsp;&nbsp;
	    <input name="score_gen" type="text" class="input1" id="SUname" value="<%=General.getScore_gen()%>"></td>
	  <td width="20%" height="39" align="right">通用技术课程实践分数：</td>
		<td width="37%" height="39" align="left">&nbsp;&nbsp;
		  <input name="score_sj" type="text" class="input1" id="stu_name" value="<%=General.getScore_sj()%>"></td>
	  </tr>  	
	<tr>
