...
%>
	<body bgcolor="#F2F2F2">
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" >
			...
			<th width="10%" height="30" align="center">序号</th>
			<th width="10%" height="30" align="center">宿舍编号</th>
			<th width="10%" align="center">楼层</th>
			<th width="10%" height="30" >宿舍楼</th>
			<th width="10%" height="30" align="center">管理员</th>
			<th width="10%" height="30" align="center">已分配人数</th>
		...
		%>
                ...
                <td width="10%" height="25" align="center">&nbsp;<a href="updata_dor_form.jsp?Dorid=<%=sData[0]%>&showPage=<%=showPage%>" target="_self"><font color="#0000FF">修改</font></a></td>
				</tr>
		<%
		...
		<p><input name="sub" type="submit" class="input1" value="删除选中的宿舍">
		&nbsp;&nbsp;
		<input name="btn" type="button" class="input1" onClick="javascript:window.location='add_dormitory.jsp'" value="添加新宿舍">
		</p>
		</form>
		<p>
		<form action="admin_dormitory.jsp" method="post" target="_self">	
			...
			<a href="admin_dormitory.jsp?showPage=1" target="_self"><font color="#0000FF">[首页]</font></a>&nbsp;			
			<%
				//判断"上一页"链接是否要显示
				if(showPage > 1)
				{				
			%>
					<a href="admin_dormitory.jsp?showPage=<%=showPage-1%>" target="_self"><font color="#0000FF">[上一页]</font> </a>&nbsp;
  <%
				}
				else
				{
				...
				{				
			%>
					<a href="admin_dormitory.jsp?showPage=<%=showPage+1%>" target="_self"><font color="#0000FF">[下一页]</font> </a>&nbsp;
		  <%
				}
				else
				{
			...
			%> 
			<a href="admin_dormitory.jsp?showPage=<%=pages.getPageCount()%>" target="_self"><font color="#0000FF">[尾页]</font> </a>&nbsp;
			转到
